...
//
//	mockgen.exe github.com/topfreegames/pitaya/v2/agent Agent,AgentFactory
//
...
// GetProcessChannel mocks base method.
func (m *MockAgent) GetProcessChannel() chan any {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetProcessChannel")
	ret0, _ := ret[0].(chan any)
	return ret0
}

// GetProcessChannel indicates an expected call of GetProcessChannel.
func (mr *MockAgentMockRecorder) GetProcessChannel() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetProcessChannel", reflect.TypeOf((*MockAgent)(nil).GetProcessChannel))
}
...
// GetStopProcessChannel mocks base method.
func (m *MockAgent) GetStopProcessChannel() chan struct{} {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetStopProcessChannel")
	ret0, _ := ret[0].(chan struct{})
	return ret0
}

// GetStopProcessChannel indicates an expected call of GetStopProcessChannel.
func (mr *MockAgentMockRecorder) GetStopProcessChannel() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetStopProcessChannel", reflect.TypeOf((*MockAgent)(nil).GetStopProcessChannel))
}
