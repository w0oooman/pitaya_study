...
const (
	...
	Pitaya_NatsCallInSingleRoutine_FullMethodName = "/protos.Pitaya/NatsCallInSingleRoutine"
...
type PitayaClient interface {
	...
	NatsCallInSingleRoutine(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
...
func (c *pitayaClient) NatsCallInSingleRoutine(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, Pitaya_NatsCallInSingleRoutine_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Pitaya_NatsCallInSingleRoutine_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PitayaServer).NatsCallInSingleRoutine(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Pitaya_NatsCallInSingleRoutine_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PitayaServer).NatsCallInSingleRoutine(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Pitaya_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "NatsCallInSingleRoutine",
			Handler:    _Pitaya_NatsCallInSingleRoutine_Handler,
		},
		{
